...
public class Main {
    public static void main(String[] args) {
        ...
        SolicitanteSubsidio s = new SolicitanteSubsidio(nombre, cedula, ingreso, cantidad, viveEnEcuador);
        System.out.println(s.toString());
        s.generarResultado();
        double consumoNormal = s.calcularConsumoMensual();
        double consumoExtra = s.calcularConsumoMensual(80);
